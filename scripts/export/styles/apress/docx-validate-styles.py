...
STYLE_PROFILES = {'apress': {'paragraph': {'BookBody': {'font': 'Palatino Linotype', 'size': 11}, 'BookHeading1': {'font': 'Segoe UI', 'size': 20}, 'BookHeading2': {'font': 'Segoe UI', 'size': 14}, 'BookHeading3': {'font': 'Segoe UI', 'size': 11}, 'BookCode': {'font': 'Consolas', 'size': 8.5}, 'BookQuote': {'font': 'Palatino Linotype', 'size': 11}, 'BookTable': {'font': 'Palatino Linotype', 'size': 9.5}, 'BookCaption': {'font': 'Segoe UI', 'size': 9}, 'BookDate': {'font': 'Palatino Linotype', 'size': 11}}, 'character': {'BookInlineCode': {'font': 'Consolas', 'size': 9}}}}
...
if __name__ == "__main__":
    ...
    parser.add_argument('--profile', default="apress",
