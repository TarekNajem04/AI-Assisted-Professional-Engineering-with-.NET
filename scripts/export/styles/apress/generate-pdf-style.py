...
Description:
    Generate a PDF theme file with Apress-inspired typography.
    Copies the dedicated pdf-theme-apress.tex to the working directory.
"""
...
def main() -> None:
    ...
    parser.add_argument('--config', default=None,
                        help='Path to export-config.json (unused in apress profile)')
    ...
    print(f"  [PROFILE] Apress PDF theme generated: {_rel(args.output, args.project_root)}")
