...
STYLE_PROFILES = {'default': {'paragraph': {'BookBody': {'font': 'Constantia', 'size': 12}, 'BookHeading1': {'font': 'Segoe UI', 'size': 28}, 'BookHeading2': {'font': 'Segoe UI', 'size': 18}, 'BookHeading3': {'font': 'Segoe UI', 'size': 14}, 'BookCode': {'font': 'Consolas', 'size': 9}, 'BookQuote': {'font': 'Constantia', 'size': 12}, 'BookTable': {'font': 'Constantia', 'size': 10}, 'BookCaption': {'font': 'Segoe UI', 'size': 10}, 'BookImageCaption': {'font': 'Segoe UI', 'size': 10}, 'BookDate': {'font': 'Constantia', 'size': 11}, 'BookTOC1': {'font': 'Segoe UI', 'size': 12}, 'BookTOC2': {'font': 'Segoe UI', 'size': 11}, 'BookTOC3': {'font': 'Segoe UI', 'size': 10}}, 'character': {'BookInlineCode': {'font': 'Consolas', 'size': 9.5}}}}
